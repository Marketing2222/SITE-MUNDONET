...
export async function initDB() {
  ...
  const igSettings = [
    ...
    { key:'ig_hero_height', value:'', label:'IG: Hero Height' },
    // IG: Marcas
    ...
    { key:'ig_hero_mobile_padding', value:'', label:'IG: Hero Mobile Padding (px)' },
    { key:'ig_brands_mobile_padding', value:'', label:'IG: Marcas Mobile Padding (px)' },
    { key:'ig_steps_mobile_padding', value:'', label:'IG: Como Funciona Mobile Padding (px)' },
    { key:'ig_calc_mobile_padding', value:'', label:'IG: Calculadora Mobile Padding (px)' },
    { key:'ig_about_mobile_padding', value:'', label:'IG: Sobre Mobile Padding (px)' },
    { key:'ig_benefits_mobile_padding', value:'', label:'IG: Benefícios Mobile Padding (px)' },
    { key:'ig_testimonials_mobile_padding', value:'', label:'IG: Depoimentos Mobile Padding (px)' },
    { key:'ig_faq_mobile_padding', value:'', label:'IG: FAQ Mobile Padding (px)' },
    { key:'ig_cta_mobile_padding', value:'', label:'IG: CTA Mobile Padding (px)' },
    ...
    { key:'ig_vis_hero_mobile', value:'true', label:'IG: Hero Visível Mobile' },
    { key:'ig_vis_brands', value:'true', label:'IG: Marcas Visível' },
    { key:'ig_vis_brands_mobile', value:'true', label:'IG: Marcas Visível Mobile' },
    { key:'ig_vis_steps', value:'true', label:'IG: Passos Visível' },
    { key:'ig_vis_steps_mobile', value:'true', label:'IG: Passos Visível Mobile' },
    { key:'ig_vis_calc', value:'true', label:'IG: Calculadora Visível' },
    { key:'ig_vis_calc_mobile', value:'true', label:'IG: Calculadora Visível Mobile' },
    { key:'ig_vis_about', value:'true', label:'IG: Sobre Visível' },
    { key:'ig_vis_about_mobile', value:'true', label:'IG: Sobre Visível Mobile' },
    { key:'ig_vis_benefits', value:'true', label:'IG: Benefícios Visível' },
    { key:'ig_vis_benefits_mobile', value:'true', label:'IG: Benefícios Visível Mobile' },
    { key:'ig_vis_testimonials', value:'true', label:'IG: Depoimentos Visível' },
    { key:'ig_vis_testimonials_mobile', value:'true', label:'IG: Depoimentos Visível Mobile' },
    { key:'ig_vis_faq', value:'true', label:'IG: FAQ Visível' },
    { key:'ig_vis_faq_mobile', value:'true', label:'IG: FAQ Visível Mobile' },
    { key:'ig_vis_cta', value:'true', label:'IG: CTA Visível' },
    { key:'ig_vis_cta_mobile', value:'true', label:'IG: CTA Visível Mobile' },
    // IG: Calculadora estilo
    { key:'ig_calc_subtitle', value:'Selecione o número de indicações:', label:'IG: Subtítulo Calculadora' },
    { key:'ig_calc_badge_text', value:'indicações', label:'IG: Texto Badge Calculadora' },
    { key:'ig_calc_bg_color', value:'linear-gradient(97deg, #e3f8ff 0%, #deefff 27.6%, #d2e6ff 48.96%, #daf2ff 86.46%, #d4fcf8 100%)', label:'IG: Cor Fundo Calculadora' },
    { key:'ig_calc_result_bg', value:'linear-gradient(61deg, #006FF9 -23.69%, #0092FF 19.37%, #00C4FE 62.42%, #00CED1 105.48%)', label:'IG: Cor Fundo Resultado' },
    { key:'ig_calc_result_color', value:'#ffffff', label:'IG: Cor Texto Resultado' },
    { key:'ig_calc_value_color', value:'#007DFF', label:'IG: Cor Valor (R$)' },
    { key:'ig_calc_slider_color', value:'#007DFF', label:'IG: Cor Slider' },
    { key:'ig_calc_border_radius', value:'32px', label:'IG: Border Radius Calculadora' },
    { key:'ig_calc_btn_text', value:'Começar a indicar', label:'IG: Texto Botão Calculadora' },
    { key:'ig_calc_btn_link', value:'#', label:'IG: Link Botão Calculadora' },
    { key:'ig_calc_note_size', value:'11px', label:'IG: Tamanho Nota Calculadora' },
    // IG: Seção "Ainda não conhece"
    { key:'ig_about_title', value:'Ainda não conhece a Mundonet?', label:'IG: Título Seção Sobre' },
    { key:'ig_about_highlight', value:'Mundonet', label:'IG: Destaque Título' },
    { key:'ig_about_desc', value:'Somos uma empresa de internet fibra óptica com tecnologia Wi-Fi 6 de ponta, conectando você ao mundo com velocidade real.', label:'IG: Descrição Seção Sobre' },
    { key:'ig_about_stat1_number', value:'50.000+', label:'IG: Número Estatística 1' },
    { key:'ig_about_stat1_label', value:'Clientes ativos', label:'IG: Label Estatística 1' },
    { key:'ig_about_stat2_number', value:'99.9%', label:'IG: Número Estatística 2' },
    { key:'ig_about_stat2_label', value:'Uptime garantido', label:'IG: Label Estatística 2' },
    { key:'ig_about_stat3_number', value:'24h', label:'IG: Número Estatística 3' },
    { key:'ig_about_stat3_label', value:'Instalação', label:'IG: Label Estatística 3' },
    { key:'ig_about_stat4_number', value:'4.9', label:'IG: Número Estatística 4' },
    { key:'ig_about_stat4_label', value:'Nota no Google', label:'IG: Label Estatística 4' },
  ...
  const empSettings = [
    ...
    { key:'emp_plans_padding', value:'', label:'Emp: Espaçamento Planos (px)' },
    ...
    { key:'emp_benefits_padding', value:'', label:'Emp: Espaçamento Benefícios (px)' },
    ...
    // Serviços
    { key:'emp_services_title', value:'Serviços disponíveis em nossos planos', label:'Emp: Título Serviços' },
    { key:'emp_services_label', value:'Serviços dedicados e exclusivos', label:'Emp: Label Serviços' },
    { key:'emp_services_label_color', value:'#a78bfa', label:'Emp: Cor Label Serviços' },
    { key:'emp_services_desc', value:'Conheça alguns serviços que sua empresa pode ter a disposição em nossos planos.', label:'Emp: Descrição Serviços' },
    { key:'emp_services_desc_color', value:'#64748b', label:'Emp: Cor Descrição Serviços' },
    { key:'emp_services_btn_text', value:'Entre em contato', label:'Emp: Texto Botão Serviços' },
    { key:'emp_services_btn_link', value:'https://api.whatsapp.com/send?phone=559830420030&text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20empresariais.', label:'Emp: Link Botão Serviços' },
    { key:'emp_services_btn_bg', value:'#7c3aed', label:'Emp: Cor Fundo Botão Serviços' },
    { key:'emp_services_btn_color', value:'#ffffff', label:'Emp: Cor Texto Botão Serviços' },
    { key:'emp_services_note', value:'Consulte disponibilidade dos serviços.', label:'Emp: Nota Serviços' },
    ...
    { key:'emp_services_padding', value:'', label:'Emp: Espaçamento Serviços (px)' },
