...
const SECTIONS: Record<string, FieldDef[]> = {
  ...
  'Banner CTA': [
    ...
    { key: 'cta_bg_color', label: 'Cor de Fundo (sem imagem)', type: 'color', hint: 'Padrão: #1a0a2e' },
    { key: 'cta_bg_gradient', label: 'Gradiente de Fundo (sem imagem)', type: 'text', hint: 'Ex: linear-gradient(135deg, #1a0a2e 0%, #2d1b4e 100%)' },
    { key: 'cta_title', label: 'Título', type: 'text', hint: 'Procurando um plano para sua empresa?' },
    { key: 'cta_title_font_size', label: 'Tamanho do Título', type: 'spacing', hint: 'Padrão: 28px' },
    { key: 'cta_desc', label: 'Descrição', type: 'text', hint: 'Planos de internet para empresas...' },
    { key: 'cta_desc_font_size', label: 'Tamanho da Descrição', type: 'spacing', hint: 'Padrão: 15px' },
    ...
    { key: 'cta_text_align', label: 'Alinhamento do Texto', type: 'align' },
    ...
    { key: 'cta_btn_font_size', label: 'Tamanho da Fonte do Botão', type: 'spacing', hint: 'Padrão: 14px' },
    { key: 'cta_btn_padding', label: 'Espaçamento do Botão', type: 'spacing', hint: 'Padrão: 12px 28px' },
    { key: 'cta_btn_border_radius', label: 'Arredondamento do Botão', type: 'spacing', hint: 'Padrão: 24px' },
    { key: 'cta_border_radius', label: 'Arredondamento do Banner', type: 'spacing', hint: 'Padrão: 16px' },
    { key: 'cta_padding', label: 'Espaçamento Interno', type: 'spacing', hint: 'Padrão: 60px 50px' },
    { key: 'cta_max_height', label: 'Altura Máxima', type: 'spacing', hint: 'Padrão: 320px' },
  ],
