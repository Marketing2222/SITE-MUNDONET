...
const FIELDS = [
  { section: 'Hero', fields: [
    ...
    { key: 'emp_hero_overlay', label: 'Ativar Overlay', type: 'toggle' },
    { key: 'emp_hero_overlay_color', label: 'Cor do Overlay', type: 'color' },
    { key: 'emp_hero_title', label: 'Título', type: 'text' },
    { key: 'emp_hero_subtitle', label: 'Subtítulo', type: 'text' },
    { key: 'emp_hero_image', label: 'Imagem de Fundo', type: 'image' },
    ...
    { key: 'emp_whatsapp_link', label: 'Link WhatsApp Float', type: 'url' },
  ]},
